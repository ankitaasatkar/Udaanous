...
create index stud on (salary);

create unique index salary_1 on sales_data(id);

alter table sales_data drop index sal;

select * from sales_data;

select * from sales_data where salary is not null;

select * from sales_data where salary is null;
